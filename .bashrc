...
__conda_setup="$('/usr/local/google/home/chunyolin/anaconda3/bin/conda' 'shell.bash' 'hook' 2> /dev/null)"
if [ $? -eq 0 ]; then
    eval "$__conda_setup"
else
    if [ -f "/usr/local/google/home/chunyolin/anaconda3/etc/profile.d/conda.sh" ]; then
        . "/usr/local/google/home/chunyolin/anaconda3/etc/profile.d/conda.sh"
    else
        export PATH="/usr/local/google/home/chunyolin/anaconda3/bin:$PATH"
    fi
fi
unset __conda_setup
# <<< conda initialize <<<
